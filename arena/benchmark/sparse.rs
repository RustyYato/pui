...
pub fn sparse(c: &mut Criterion) {
    ...
    c.bench_function("sparse re-insertion", |b| {
        let mut arena = Arena::new();
        b.iter(|| {
            let arena = black_box(&mut arena);
    ...
    c.bench_function("sparse iteration non-contigious", |b| {
        let mut arena = Arena::new();
    ...
    c.bench_function("sparse iteration contigious", |b| {
        let mut arena = Arena::new();
    ...
    c.bench_function("sparse iteration packed", |b| {
        let mut arena = Arena::new();
